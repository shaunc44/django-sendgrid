...
REPOSITORY = "git@github.com:shaunc44/django-sendgrid-3.git"
REPOSITORY_NAME = "django-sendgrid-3"
...
def restart_apache():
	...
	setEnv = ";".join("export {0}={1}".format(var, val) for var, val in envVars.items())
	with prefix(setEnv):
